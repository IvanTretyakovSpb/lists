...
public class RedBlackTreeApp {
    public static void main(String[] args) {
        ...
        redBlackTree.insert(10).insert(20).insert(5).insert(40)
                .insert(50).insert(25).insert(60).insert(80)
                .insert(85).insert(90).insert(30).insert(15)
                .insert(75).insert(102).insert(55).insert(45)
                .insert(7).insert(26);
